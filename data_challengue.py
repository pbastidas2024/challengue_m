...
# Leer el archivo CSV
input_csv = "/mnt/c/prueba/gpon_challengue.csv"
df = pd.read_csv(input_csv)
print("Archivo CSV leído")  # Mensaje de depuración
...
kpi_columns = ['ESTABLISHED_CALLS', 'FAILED_CALLS', 'NEW_REG', 'EXPIRED_REG', 'FAILED_REG', 'GONE_REG', 'UNAUTHORIZED_REG']
resampled_dfs = []
...
print("Datos transformados y resampleados")  # Mensaje de depuración

# Guardar el archivo CSV con nombre especificado en el directorio del repositorio
output_filename = "/home/pbastidas/repos/challengue_m/GPON_CSV_OUTPUT-{}.csv".format(datetime.now().strftime('%H-%M-%S'))
